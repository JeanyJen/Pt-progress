        ...
        <div class="col-lg-7">
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <!-- <div class="col-lg-6 d-none d-lg-block bg-login-image"></div>  untuk menampilkan gambar-->
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form class="user" action="<?php echo site_url('auth/login') ?>" method="post">
                                    <!-- <form action="<?php // echo site_url('admin/karyawan/simpan') 
                                                        ?>" method="POST" id="tambah_karyawan"> -->
